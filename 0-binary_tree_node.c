...
/**
 * binary_tree_t *binary_tree_parent_node - function that creates a binary tree parent_node
...
binary_tree_t *binary_tree_parent_node(binary_tree_t *parent, int value)
{
